...
var downloadNewVersion = function (program) {                                                                   // 93
  ...
  _.times(Math.min(MAX_NUM_CONCURRENT_DOWNLOADS, queue.length), function () {                                   // 171
    ...
    // downloads                                                                                                // 174
    Meteor.setTimeout(downloadUrl.bind(null, nextUrl), 50);                                                     // 175
  });                                                                                                           // 176
};                                                                                                              // 177
                                                                                                                // 178
